...
agent = FunctionCallingAgentWorker.from_tools([weather_tool_C, weather_tool_F], verbose=True)

response = agent.as_agent().chat("What's the temparture in Delhi in °F and in °C?")
